...
@InputType()
class TrainingCreateNestedManyWithoutApplicationsInput {
...
export { TrainingCreateNestedManyWithoutApplicationsInput as TrainingCreateNestedManyWithoutApplicationsInput };
