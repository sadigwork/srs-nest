...
@InputType()
class EducationCreateNestedManyWithoutApplicationsInput {
...
export { EducationCreateNestedManyWithoutApplicationsInput as EducationCreateNestedManyWithoutApplicationsInput };
