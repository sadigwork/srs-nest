...
@InputType()
class ApplicationUpdateManyWithoutInstitutionsInput {
...
export { ApplicationUpdateManyWithoutInstitutionsInput as ApplicationUpdateManyWithoutInstitutionsInput };
